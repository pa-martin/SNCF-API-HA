...
export class SncfTrainCardEditor extends HTMLElement {
  ...
  private emitConfigChange() {
    ...
    const nextConfig: SncfTrainCardConfig = {
      ...
      train_emoji_axial_symmetry: Boolean(get('train_emoji_axial_symmetry')?.checked),
      ...
      show_departure_station: Boolean(get('show_departure_station')?.checked),
      show_arrival_station: Boolean(get('show_arrival_station')?.checked),
